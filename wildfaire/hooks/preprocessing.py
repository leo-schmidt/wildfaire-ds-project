...
# from tf.Tensorflow import tf.Tensor, concat as tf_concat, image, clip_by_value, math
...
if directory.endswith('hooks'):
    ...
    dirname = 'raw_data'
train_pattern = os.path.join(dirname, 'next_day_wildfire_spread_train*')
...
def _get_features_dict(
  ...
  """Creates a features dictionary for tf.TensorFlow IO.
  ...
  Returns:
    A features dictionary for tf.TensorFlow IO.
  """
...
def _parse_fn(
  ...
  Args:
    example_proto: A tf.TensorFlow example protobuf.
